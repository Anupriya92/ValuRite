        ...
        function fnassgnApprr(e) {
            ...
            if ($('#ddlAppraiserlist :selected').val() == 'none') {
               ...
               // bootbox.alert("Select a Property")
                ...
                var selappraiserID = $('#ddlAppraiserlist :selected').attr('title');
                selappraiserID = selappraiserID.split("<br />");
                selappraiserID = selappraiserID[0].split(":");
                var obj = {
                    //AppraiserID: selappraiserID[0],
                    AppraiserID: selappraiserID[1].trim(),
                    ValuationID: Propdet,
                    Reassign: Reassign
            ...
            if (chkshowrejlist.checked) {
                if ($('#ddlAppraiserlist :selected').val() == 'none') {
                   ...
                   // var appraiserID = Propdet[3];
                    ...
                    // appraisersplit = appraisersplit.split(',');
                    //Borrower ID..
                    var borrowersplit = $('#ddlborrowerlist :selected').attr('title');
                    borrowersplit = borrowersplit.split("<br />");
                    borrowersplit = borrowersplit[0].split(":");
                    //Appraiser ID..
                    var appraisersplit = $('#ddlAppraiserlist :selected').attr('title');
                    appraisersplit = appraisersplit.split("<br />");
                    appraisersplit = appraisersplit[0].split(":");
                    
                    var obj = {
                        // BorrowerID: borrowerID,
                        BorrowerID: borrowersplit[1].trim(),
                        UserID: '<%=Session["UserID"]%>',
                        //AppraiserID: appraisersplit[1].trim(),
                        AppraiserID: appraisersplit[1].trim(),
                        //PropertyID: propertyID,
                        PropertyID: Propdet,
                        //ValuationID: valuationID,<%--Added by Anupriya--%>
                        ValuationID: $('#refidtxtbox').val(),
                ...
                if (UserType == "Appraiser" && UserRole == "Ind app without lender" && ortype == "Individual") {
                    if ($('#ddlborrowerlist :selected').val() == 'none') {
                       ...
                       // bootbox.alert("Select a Property")
                        ...
                        borrowersplit = borrowersplit[0].split(":");                       
                        //Lender ID...
                        var lendersplit = $('#ddllenderlist :selected').attr('title');
                        lendersplit = lendersplit.split("<br />");
                        lendersplit = lendersplit[0].split(":");
                      ...
                      //  bootbox.alert("Select a Borrower")
                       ...
                       // bootbox.alert("Select an Appraiser")
                        ...
                        var obj = {
                            ...
                            UserID: '<%=Session["UserID"]%>',
                            //AppraiserID: appraisersplit[0],
                            //AppraiserID: $('#ddlAppraiserlist :selected').val(),
                            AppraiserID: appraisersplit[1].trim(),
                            PropertyID: $('#ddlvaluationID :selected').val(),
                            ApproverID: '<%=Session["UserID"]%>',
                            ValuationID: $('#refidtxtbox').val(),<%--Added by Anupriya--%>
    ...
    <div>
        <div>
            ...
            <div class="modal-header-primary" align="center">
                <span class="sectionheader labeltxtassign" style="margin-left: -66px;">
            ...
            <div>
                ...
                <div class="col-lg-5 col-md-8 col-sm-8 col-xs-12">
                    <div class="row labeltxt">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style ="margin-left: 10px;">
