        ...
        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10" id="divapprovedapps">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div>
                        <button type="button" style="z-index: 10;margin-top: 30px;" class="btn btn-sm btnshow" id="btnapprovedapps" onclick="fnloadAppList()" disabled="disabled" title="View Approved Application(s)">
