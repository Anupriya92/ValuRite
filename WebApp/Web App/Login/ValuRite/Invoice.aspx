    ...
    <script type="text/javascript">
        ...
        function fnRaiseInvoice() {         
                ...
                table.$('tbody tr').each(function (index, rowhtml) {
                    ...
                    if (checked == 1) {
                        ...
                        $(this).find('td').each(function (tdindex, tdhtml) {
                            if (tdindex == 1) {
                                ValuationArr.push($(tdhtml).html());
                                alert("ValuationArr " + JSON.stringify(ValuationArr))
                            }
                                // Added the below block by Nirmala on 18th June 2019 --Start to check the validation and to add alert
                            else if (tdindex == 2) { // || tdindex == 3) {
                                obj["InvoiceAmt"] = $(tdhtml).find('input').val().trim();
                                InvoiceArr.push($(tdhtml).find('input').val().trim());
                                alert("InvoiceArr " + JSON.stringify(InvoiceArr))
                                if (obj["InvoiceAmt"] == "") {
                                    bootbox.dialog({
                                        closeButton: true,
                                        size: 'medium',
                ...
                if (rowschecked == false) {// || obj["InvoiceAmt"] == "") {
                    ...
                    $('#modalloading').modal('hide');
                    Invoiceraise.push(obj);
                    alert(" " + $("#ddllenderlist").val().toString());
                    var obj = {
                        ValuationID: ValuationArr.join(),
                        LenderID: $("#ddllenderlist").val().toString(),
                        Amount: InvoiceArr.join(),
                    ...
                    alert("Invoice obj "+JSON.stringify(obj))
                    var jsonobj = JSON.stringify(obj);
                    // --End
                    //alert(jsonobj);
                    $.ajax({
        ...
        function fnInvoice(pagebtn) {            
            ...
            if ($("#ddllenderlist").val() == null || $("#ddllenderlist").val() == "none") {
                bootbox.dialog({
                    closeButton: true,
                    size: 'medium',
                ...
                <div class="">
                    <div class="accordionShoHide" id="div_export" runat="server">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                            <div class="row" align="center" style="padding-top: 28px">
                                                ...
                                                <label id="lbllenderlist">Lender List: </label>
                                                 <%-- <asp:DropDownList runat="server"CssClass="form-control custom-select" data-toggle="tooltip">
                                                    <asp:ListItem Text="Select Lender"  ID="ddllenderlist"  Value="none"></asp:ListItem>
                                                </asp:DropDownList>--%>
                        ...
                        <asp:ListItem Text="Select Lender" Value="none"></asp:ListItem>
                                    ...
                                    <div>
                                        <!--onclick="fnRaiseInvoice()"-->
                                        <button type="button" id="Raisebutton" value="RaiseInvoice" class="btn btnsave" onclick="fnRaiseInvoice()" style="display: none">RaiseInvoice</button>
                                    </div>
                                            ...
                                            <div class="modal-content">
                                                <div class="" style="">
                                                    ...
                                                    <div class="col-lg-4" style="top: 180px;">
                                                        <asp:Image ID="LoadImage" runat="server" ImageAlign="AbsMiddle" ImageUrl="~/Images/1234.gif" />
                                                    </div>
                                                    <div class="col-lg-4">
                                                    </div>
                                                </div>
