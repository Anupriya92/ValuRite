...
router.post('/', function(req, res, next) {
    try {
		...
		console.log(ValuationID+" ValuationID ID");
		console.log(VisitDateTime+" VisitDateTime ID");
		console.log(RequiredDocs+" RequiredDocs ID");
		console.log(ScheduleDescription+" ScheduleDescription ID");
		console.log(BorrowerName+" BorrowerName ID");
		console.log(BorrowerNo+" BorrowerNo ID");
		console.log(BorrowerEmail+" BorrowerEmail ID");
		console.log(PropertyType+" PropertyType ID");
		console.log(PropertyAddress+" PropertyAddress ID");
		console.log(ScheduleID+" ScheduleID ID");
		console.log(RescheduleReason+" RescheduleReason ID");
