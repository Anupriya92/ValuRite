    ...
    try {
        ...
        //req.on("end", function() {
			...
			if(GetAppraisalStatus=="InProgress"){
				console.log("InProgress"+ GetAppraisalStatus)
				updatedata="{ \"AppraisalStatus\":\"" + GetAppraisalStatus + "\",\"ModifiedDate\":\"" + CurrentDate + "\",\"ModifiedBy\":\"" + UserID + "\" ,\"DateofInspection\":\"" + DateOfInspection + "\"}";
			}
			else if(GetAppraisalStatus=="Completed"){
				updatedata="{ \"AppraisalStatus\":\"" + GetAppraisalStatus + "\",\"ModifiedDate\":\"" + CurrentDate + "\",\"ModifiedBy\":\"" + UserID + "\" ,\"DateofValuation\" :\""+ CurrentDate+"\"}";
			}
			else{
				updatedata="{ \"AppraisalStatus\":\"" + GetAppraisalStatus + "\",\"ModifiedDate\":\"" + CurrentDate + "\",\"ModifiedBy\":\"" + UserID + "\" }";
			}
            ...
            console.log(GetAppraisalStatus);
