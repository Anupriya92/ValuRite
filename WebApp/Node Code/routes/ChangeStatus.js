          ...
          //req.on("end", function() {
			...
			collection.find({'ValuationID':ValuationID,'ValuationStatus':'true'},function(err, docs) {
				...
				docs.forEach(function(subdocs){
					...
					BuildingStatus=subdocs.BuildingStatus;
					...
					else if(BuildingStatus=="Retrieved")
					{
						collection.update({'ValuationID':ValuationID,'ValuationStatus':'true'}, {$set : { BuildingStatus : "Completed"}});
					}
