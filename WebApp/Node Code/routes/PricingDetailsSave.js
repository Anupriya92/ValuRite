...
collection.find({'ValuationID':ValuationID,'ValuationStatus':'true'},function(err, docs) {
	...
	"PricingPropertyDetails" : {
	       ...
	       "Livable" : {
			...
			"Rooms" :{
				"NoofRooms" : NoofRooms,
				"RoomDescription" : jsonObj["RoomDescription"]
			},
			"PropertyNorth" : jsonObj["PropertyNorth"],
			"PropertySouth" : jsonObj["PropertySouth"],
			"PropertyEast" : jsonObj["PropertyEast"],
			"PropertyWest" : jsonObj["PropertyWest"]
	    },
	//"SurveyDetails" :{
