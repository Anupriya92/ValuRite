...
(function ($) {
    ...
    BioCircos = function () {
        ...
        self.settings = {
            ...
            "SNPMouseOverTooltipscursor":"pointer",
    ...
    BioCircos.prototype.draw_genome = function (genome) {
        ...
        BioCircos.prototype.getthis = function () {
            return self;
        }
        ...
        if (self.zoom == true) {
            ...
            svg = d3.select(self.target).append("svg")
                .attr("width", width)
                .attr("height", height)
                .call(
                    d3.behavior.zoom()
        ...
        BioCircos.prototype.getsvg = function () {
            return svg;
        }

        BioCircos.prototype.getd3 = function()
        {
            return d3;
        }
        ...
        if (self.genomeTextDisplay == true) {
            svg.append("g").selectAll("text")
                ...
                .style("font-size", self.genomeTextSize-3)
        ...
        if (self.SNP.length > 0) {
                ...
                if (self.SNPsettings.PointType == "circle") {
                    if (self.SNPsettings.SNPAnimationDisplay == false) {
                        svg.append("g")
                            ...
                            .attr("cx", function (d) { 
                                if(d.snp_des == "pos_start_grch38" || self.target == "#variantbiocircos")
                                {
                                    if(JSON.stringify(d.x) == null || JSON.stringify(d.x) == "null")
                                    {
                                    return "-28.83453887833682";
                                    }
                                }else if(d.snp_des == "pos_start_grch37")
                                {
                                    if(JSON.stringify(d.x) == null || JSON.stringify(d.x) == "null")
                                    {
                                    return "-18.83453887833682";
                                    }
                                }
                                    return d.x; 
                            })
                            .attr("cy", function (d) { 
                                if(d.snp_des == "pos_start_grch38" || self.target == "#variantbiocircos")
                                {
                                    if(JSON.stringify(d.y) == null || JSON.stringify(d.y) == "null")
                                    {
                                    return "-175.5800966340261";
                                    }
                                }else if(d.snp_des == "pos_start_grch37")
                                {
                                    if(JSON.stringify(d.y) == null || JSON.stringify(d.y) == "null")
                                    {
                                    return "-150.5800966340261";
                                    }
                                }
                                    return d.y; 
                            });
            ...
            if (self.settings.SNPMouseEvent == true) {
                ...
                if (self.settings.SNPMouseOverDisplay == true) {
                    SNPMouseOn.on("mouseover", function (d) {
                        ...
                        d3.select(this)
                            ...
                            .style("cursor", function (d, i) { if (self.settings.SNPMouseOverTooltipscursor == "none") { return ""; } else { return self.settings.SNPMouseOverTooltipscursor; } })
                ...
                //         alert(self.settings.SNPMouseOverTooltipsHtml01+d.snp_chr+self.settings.SNPMouseOverTooltipsHtml02+d.snp_pos+self.settings.SNPMouseOverTooltipsHtml03+d.snp_val+/*self.settings.SNPMouseOverTooltipsHtml04+d.snp_des+*/self.settings.SNPMouseOverTooltipsHtml05)
                //     })
                // }
                ...
                if (self.settings.SNPMouseOutDisplay == true) {
                    SNPMouseOn.on("mouseout", function (d) {
                        SNPMouseOnTooltip.style("opacity", 0.0);
                        SNPMouseOnTooltip.style("z-index", -1);
                        d3.select(this)
                            .transition()
                ...
                BioCircos.prototype.hideTooltip = function () {
                    SNPMouseOnTooltip.style("opacity", 0.0);
                    // d3.select(this)
                    //     .transition()
                    //     .duration(self.settings.SNPMouseOutAnimationTime)
